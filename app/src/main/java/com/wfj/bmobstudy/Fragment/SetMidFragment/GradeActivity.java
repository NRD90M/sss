...
import com.wfj.bmobstudy.Adapter.GradeAdapter;

import com.wfj.bmobstudy.Bean.Grade;
import com.wfj.bmobstudy.Constant.UstsValue;
import com.wfj.bmobstudy.R;
import com.wfj.bmobstudy.Utils.ClientInstance;

import com.wfj.bmobstudy.Utils.GradeUtil;
 ...
 * @date: 2020/4/26
 * @author: a */
public class GradeActivity extends AppBaseActivity {
    ...
    private void initViews() {
        ...
        ly_grade_select = (LinearLayout) findViewById(R.id.ly_grade_select);
        et_grade_code = (EditText) findViewById(R.id.et_grade_code);
        iv_grade_code = (ImageView) findViewById(R.id.iv_grade_code);
        btn_grade_get_code = (Button) findViewById(R.id.btn_grade_get_code);
        btn_grade_get_code.setOnClickListener(new get_codeOnClickListener());
        btn_grade_select = (Button) findViewById(R.id.btn_grade_select);
        btn_grade_select.setOnClickListener(new loginOnClickListener());
        expanda_lv = (ExpandableListView) findViewById(R.id.expand_lv);
    ...
    private void initChoose() {
        ly_multiply = (LinearLayout) findViewById(R.id.ly_multiply);
        tv_xueNian = (TextView) findViewById(R.id.tv_xuenian);
        tv_xueQi = (TextView) findViewById(R.id.tv_xueqi);
    ...
    private void login(String code) {
        ...
        ShowDialogUtil.showProgressDialog(context, message);
                ...
                handle_grade_html(grade_html, new call() {
                    ...
                    public void success(List<Grade> l) {
                        getParent().runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                expanda_lv.setAdapter(new GradeAdapter(context, list));
                                ShowDialogUtil.closeProgressDialog();
                                if (list.size() == 0) {
