...
import com.wfj.bmobstudy.Activity.LoginActivity;
import com.wfj.bmobstudy.Bean.User;
import com.wfj.bmobstudy.Bean.Version;
import com.wfj.bmobstudy.Fragment.Advice.AdviceFragment;
import com.wfj.bmobstudy.Fragment.SetMidFragment.AboutUsFragment;
import com.wfj.bmobstudy.Fragment.SetMidFragment.BindingFragment;
import com.wfj.bmobstudy.Fragment.MyMessage.MyMessageFragment;
import com.wfj.bmobstudy.Fragment.SetMidFragment.SetAccountFragment;
import com.wfj.bmobstudy.Fragment.SetMidFragment.StudentVerifyFragment;
import com.wfj.bmobstudy.Fragment.SetMinFragment.UpdateVersionFragment;
import com.wfj.bmobstudy.R;
import com.wfj.bmobstudy.Utils.SharedPreferenceUtils;
...
public class SettingFragment extends Fragment {
    ...
    private void initUpdateIfo(View v) {
        ...
        query.findObjects(new FindListener<Version>() {
            ...
            public void done(List<Version> list, BmobException e) {
                ...
                int new_code =0;
                if (list!=null){
                    new_code = list.get(0).getVersion();
    ...
    private void changeFragment(int content, Fragment fragment) {
        ...
        fragmentManager.beginTransaction()
                ...
                .addToBackStack(null)
                .commit();
        if (getActivity().findViewById(R.id.viewPager).getVisibility() == (View.VISIBLE)){
