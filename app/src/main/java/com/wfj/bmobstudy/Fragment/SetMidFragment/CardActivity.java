...
import com.wfj.bmobstudy.Adapter.CardAdapter;
import com.wfj.bmobstudy.Bean.Card;
...
import com.wfj.bmobstudy.Utils.SSLSocketClient;
 ...
 * @date: 2020/4/26
 * @author: a */
public class CardActivity extends AppBaseActivity {
...
//        });
        ...
        iv_card_code = (ImageView) findViewById(R.id.iv_card_code);
        btn_card_get_code = (Button)findViewById(R.id.btn_card_get_code);
        ...
        btn_card_select = (Button)findViewById(R.id.btn_card_select);
...
//                imm.toggleSoftInput(0, InputMethodManager.HIDE_NOT_ALWAYS);
                hideSoftInputView();
                ShowDialogUtil.showProgressDialog(context, "正在查询一卡通消费记录...");
        ...
        ly_card_select = (LinearLayout) findViewById(R.id.ly_card_select);
        ...
        try {
            ...
            this.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.show(context, "您还没有进行学生身份验证！", 1);
                }
            });
            return;
        }
                ...
                handle_card_history_html(response.body().string(), new call() {
                    ...
                    public void success(final List<Card> list) {
                        getParent().runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ShowDialogUtil.closeProgressDialog();
                                expand_lv.setAdapter(new CardAdapter(context, list));
    ...
    public void in_ui_thread_show_dialog(final String msg) {
        this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                ShowDialogUtil.showProgressDialog(context, msg);
            }
        });
    }
