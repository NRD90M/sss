...
import com.wfj.bmobstudy.Utils.PhoneUtils;
import com.wfj.bmobstudy.Utils.TimeCountUtil;
...
public class UpdatePhoneFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_update_phone, null, false);
        initViews(v);
        return v;
    }
