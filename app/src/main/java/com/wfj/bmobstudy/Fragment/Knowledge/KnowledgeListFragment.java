package com.wfj.bmobstudy.Fragment.Knowledge;
...
import com.wfj.bmobstudy.Adapter.KnowledgeAdapter;
...
public class KnowledgeListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (rootView == null) {
            View v = inflater.inflate(R.layout.fragment_knowledge_list, null, false);
