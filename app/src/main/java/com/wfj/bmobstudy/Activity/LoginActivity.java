...
import com.wfj.bmobstudy.Constant.AppValue;
...
public class LoginActivity extends AppBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bmob.initialize(this, AppValue.APPLICATION_ID);
        initPush();
        RxTool.init(this);
        initViews();
        avoid_login();
    ...
    private void avoid_login() {
        final String account = SharedPreferenceUtils.spGetString(LoginActivity.this, "avoid_login", "account");
        final String password = SharedPreferenceUtils.spGetString(LoginActivity.this, "avoid_login", "password");
        ...
        switch (v.getId()) {
            case R.id.btn_register:
                if (TextUtils.isEmpty(account) || TextUtils.isEmpty(password)) {
                    ...
                    ShowDialogUtil.showProgressDialog(LoginActivity.this, "正在注册...");
                    BmobUser bmobUser = new BmobUser();
                    ...
                    bmobUser.signUp(new SaveListener<BmobUser>() {
                        ...
                        public void done(BmobUser bmobUser, BmobException e) {
                            if (e == null) {
                                ...
                                SharedPreferenceUtils.save(account, password, LoginActivity.this);
                                startActivity(new Intent(LoginActivity.this, MainActivity.class));
                                overridePendingTransition(R.anim.in_from_right, R.anim.out_to_left);
                                finish();
                            } else {
            ...
            case R.id.btn_login:
                if (TextUtils.isEmpty(account) || TextUtils.isEmpty(password)) {
                    ...
                    ShowDialogUtil.showProgressDialog(LoginActivity.this, "正在登录...");
                    BmobUser bmobUser = new BmobUser();
                    bmobUser.loginByAccount(account, password, new LogInListener<BmobUser>() {
                        @Override
                        public void done(BmobUser bmobUser, BmobException e) {
                            if (bmobUser != null) {
                                Toast.show_success(LoginActivity.this, "登录成功！");
                                SharedPreferenceUtils.save(account, password, LoginActivity.this);
                                startActivity(new Intent(LoginActivity.this, MainActivity.class));
                                overridePendingTransition(R.anim.in_from_right, R.anim.out_to_left);
                                finish();
