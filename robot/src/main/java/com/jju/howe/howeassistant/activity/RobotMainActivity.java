...
public class RobotMainActivity extends Activity implements View.OnClickListener {

    private static String TAG = RobotMainActivity.class.getSimpleName();
    private MainBean mMainBean;
    private SpeechUnderstander mSpeechUnderstander;
    private Toast mToast;
    private TextView mAskText, mUnderstanderText;
    static public AnimationDrawable background;

    public static boolean service_flag = false;//表示是否在一项服务中
    public static String SRResult = "";    //识别结果
    public static int[] imgs = { R.drawable.robot_with_eye001,
            R.drawable.robot_with_eye002, R.drawable.robot_with_eye003,
            R.drawable.robot_with_eye004, R.drawable.robot_with_eye005,
            R.drawable.robot_with_eye006 };
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mainrobot);
        SpeechUtility.createUtility(this, SpeechConstant.APPID + "=58057ac8");

        // 初始化对象
        mSpeechUnderstander = SpeechUnderstander.createUnderstander(RobotMainActivity.this, mSpeechUdrInitListener);

        mToast = Toast.makeText(RobotMainActivity.this, "", Toast.LENGTH_SHORT);

        mTts = SpeechSynthesizer.createSynthesizer(RobotMainActivity.this, mTtsInitListener);
        initLayout();
    }
    ...
    private void initLayout() {
        ...
        icon_show.setImageResource(R.drawable.ani_shake);
        background = (AnimationDrawable) icon_show.getDrawable();

        mUnderstanderText.setText("我能帮您做什么吗?");
        speakAnswer("我能帮您做什么吗?");

        buttonFloat = (ButtonFloat) findViewById(R.id.buttonFloat);
        buttonFloat.setBackgroundColor(Color.parseColor("#cdd1e7"));

        buttonFloat.setOnClickListener(RobotMainActivity.this);
        icon_show.setOnClickListener(RobotMainActivity.this);
    }
    ...
    public void onClick(View view) {
        int id = view.getId();// 开始语音理解
        if (id == R.id.buttonFloat) {
            buttonFloat.setBackgroundColor(Color.parseColor("#7c8dc1"));
            mTts.stopSpeaking();
            ...
            if (i % 2 == 0) {
                ...
                i++;
                icon_show.setImageResource(R.drawable.ani_jump);
                background = (AnimationDrawable) icon_show.getDrawable();
    ...
    public void help(View view) {
        startActivity(new Intent(RobotMainActivity.this, HelpActivity.class));
    }
...
//            icon_show.setImageResource(R.drawable.jiangzi);
        ...
        public void onBeginOfSpeech() {
            ...
            icon_show.setImageResource(RobotMainActivity.imgs[i]);
        }

        @Override
        public void onError(SpeechError error) {
//            icon_show.setImageResource(R.drawable.qianzhou);
...
//                icon_show.setImageResource(R.drawable.haobangbang);
            }
        }
    ...
    public void speakAnswer(String text) {
        // 移动数据分析，收集开始合成事件
        FlowerCollector.onEvent(RobotMainActivity.this, "tts_play");

        int code = mTts.startSpeaking(text, mTtsListener);
//        icon_show.setImageResource(R.drawable.buyaojiang);
//        mFiveLine.setVisibility(View.VISIBLE);
            ...
            switch (service) {
                ...
                case "telephone":
                    switch (operation) {
                        case "CALL": {    //1打电话
                            ...
                            //可由多个可选条件确定必要条件
                            CallAction callAction = new CallAction(slotsBean.getName(), slotsBean.getCode(), RobotMainActivity.this);//目前可根据名字或电话号码拨打电话
                            callAction.start();
                            break;
                        }
                        case "VIEW": {    //2查看电话拨打记录
                ...
                case "message": {//2 短信相关服务
                    ...
                    switch (operation) {
                        ...
                        case "SEND": {//1发送短信
                            SendMessage sendMessage = new SendMessage(slotsBean.getName(), slotsBean.getCode(), slotsBean.getContent(), RobotMainActivity.this);
                            sendMessage.start();
                            break;
                        }
                ...
                case "app": {//3 应用相关服务
                    ...
                    switch (operation) {
                        ...
                        case "LAUNCH": {//1打开应用
                            OpenAppAction openApp = new OpenAppAction(slotsBean.getName(), RobotMainActivity.this);
                            openApp.start();
                            break;
                        }
                ...
                case "websearch": {//5 搜索相关服务
                    ...
                    switch (operation) {
                        ...
                        case "QUERY": {//1搜索
                            ...
                            SearchAction searchAction = new SearchAction(slotsBean.getKeywords(), RobotMainActivity.this);
                            searchAction.Search();
                            break;
                        }
    ...
    protected void onResume() {
        //移动数据统计分析
        FlowerCollector.onResume(RobotMainActivity.this);
    ...
    protected void onPause() {
        ...
        FlowerCollector.onPause(RobotMainActivity.this);
        super.onPause();
    }
