...
@SuppressLint("NewApi") public class ButtonFloat extends Button {
	...
	protected void setDefaultProperties(){
		...
		rippleSize = dpUtils.dpToPx(5, getResources());
...
//		super.setDefaultProperties();
	...
	protected void setAttributes(AttributeSet attrs){
		...
		final boolean animate = attrs.getAttributeBooleanValue(MATERIALDESIGNXML,"animate", false);
			post(new Runnable() {
				...
				@Override
				public void run() {
					showPosition = ViewHelper.getY(ButtonFloat.this) - dpUtils.dpToPx(24, getResources());
	...
	protected void onDraw(Canvas canvas) {
		...
		if (x != -1) {
			...
			Rect dst = new Rect(dpUtils.dpToPx(1, getResources()), dpUtils.dpToPx(2, getResources()), getWidth()- dpUtils.dpToPx(1, getResources()), getHeight()- dpUtils.dpToPx(2, getResources()));
